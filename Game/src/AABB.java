...
public class AABB {
	...
	public AABB(Vectors pos, int w, int h) {
		this.pos = pos;
		this.w = w;
		this.h = h;
	...
	public AABB(Vectors pos, int r, Entity e) {
		this.pos = pos;
		this.r = r;
	...
	public void setAggroV1(Vectors pos, int w, int h) {
		this.pos = pos;
		this.w = w;
		this.h = h;
	...
	public void setAggroV2(Vectors pos, int r) {
		this.pos = pos;
		this.r = r;
	...
	public boolean AggroRadiusColBox(AABB aBox) {
